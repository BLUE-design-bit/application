...
功能与使用路径首轮审定已完成：106项功能、12类使用路径，M08已删除。PLC覆盖已确定为汇川小型、汇川中大型、欧姆龙三组，具体型号/版本待补，详见 [功能范围审定稿](functional-scope-review.md)。当前待审定Excel记录结构，并继续完善设备组合及测试条件。现有 Excel 仍为原109项版本，尚未按确认范围重排；旧版按操作编排的条目不作为新版结构。
