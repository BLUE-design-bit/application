...
功能与使用路径首轮审定已完成：106项功能、12类使用路径，M08已删除，详见 [功能范围审定稿](functional-scope-review.md)。下一阶段确认实际PLC平台与设备组合，再分阶段完善测试条件及Excel记录结构。现有 Excel 仍为原109项版本，尚未按确认范围重排；旧版按操作编排的条目不作为新版结构。
